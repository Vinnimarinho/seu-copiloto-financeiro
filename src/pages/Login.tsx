    ...
    <div className="min-h-screen gradient-hero flex items-center justify-center p-6">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="font-heading text-2xl font-bold text-sidebar-foreground">Entrar</h1>
          <p className="text-sm text-sidebar-foreground/60 mt-1">Acesse sua conta no Lucius</p>
        </div>
